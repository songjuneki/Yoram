...
class PrefViewModel(private val userRepository: UserRepository, private val serverRepository: ServerRepository): ViewModel() {
    ...
    // MARK: - AdminWorship
    private val worshipClickListener = object: AdminWorshipListAdapter.AdminWorshipClickListener {
    ...
    // MARK: - AdminGive
    private val giveTypeClickListener = object: AdminGiveTypeListAdapter.AdminGiveTypeClickListener {
        override fun onClick(index: Int) {
    ...
    fun btnEvent(btnId: Int) {
        when (btnId) {
            ...
            R.id.frag_my_pref_rule_rule -> { moveFragment(R.id.action_prefFragment_to_prefRuleFragment); _ruleType.value =
                RuleType.APP
            }
            R.id.frag_my_pref_rule_privacy -> { moveFragment(R.id.action_prefFragment_to_prefRuleFragment); _ruleType.value =
                RuleType.PRIVACY
            }
            ...
            R.id.frag_my_pref_admin_board -> moveFragment(R.id.action_prefFragment_to_adminBoardFragment)
        }
    }
    fun backBtn() {
