...
class AdminPositionListAdapter(private val clickListener: AdminDepartmentClickListener, private val currentCode: Int = 0): ListAdapter<Position, AdminPositionListAdapter.ViewHolder>(
    diffUtil
) {
