...
class BoardCategoryListAdapter(val onCategoryChanged: (ReservedBoardCategory?) -> Unit, val onSelectedClick: (Int) -> Unit): ListAdapter<ReservedBoardCategory, RecyclerView.ViewHolder>(
    diffUtil
) {
