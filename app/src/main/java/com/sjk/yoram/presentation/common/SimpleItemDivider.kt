package com.sjk.yoram.presentation.common
...
class SimpleItemDivider(context: Context, orientation: Int): RecyclerView.ItemDecoration() {
    val HORIZONTAL = LinearLayout.HORIZONTAL
    val VERTICAL = LinearLayout.VERTICAL

    private val TAG = "SimpleItemDivider"
