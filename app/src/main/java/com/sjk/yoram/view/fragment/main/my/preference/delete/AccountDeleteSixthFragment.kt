...
import com.sjk.yoram.databinding.FragMyPrefAccountDeleteSixthBinding
import com.sjk.yoram.viewmodel.AccountDeleteViewModel

class AccountDeleteSixthFragment: Fragment() {
    private lateinit var binding: FragMyPrefAccountDeleteSixthBinding
    ...
    override fun onCreateView(
        ...
        binding = FragMyPrefAccountDeleteSixthBinding.inflate(layoutInflater)
